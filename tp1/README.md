...
hotel_bookings.csv              # Dataset (en la raíz del repo)
```
...
jupyter notebook entregas/tp1/TP1_hotel_bookings.ipynb
```
...
Dataset público *Hotel Booking Demand*, originalmente publicado por Antonio, Almeida y Nunes (2019) en *Data in Brief*. Disponible en Kaggle.
